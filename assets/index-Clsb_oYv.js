...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",R.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),R.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>R.jsxs("div",{className:"CommentList",children:[e.map(t=>R.jsx(Pc,{comment:t})),";"]}),Tc=({user:e})=>R.jsxs("p",{children:[" Posted by  ",R.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Mc=({post:e})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),R.jsx(Tc,{user:e.user})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length===0?R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}):R.jsx(Lc,{comments:e.comments})]}),Rc=({postList:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Mc,{post:t},t.id))});function Dc(e){return Nc.find(t=>t.id===e)||null}function jc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId)})).map(e=>({...e,comments:jc(e.id)})),Fc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{postList:Oc})]});em(document.getElementById("root")).render(R.jsx(Fc,{}));
